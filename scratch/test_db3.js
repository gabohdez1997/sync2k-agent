...
async function run() {
    try {
        ...
        let defaultLin = data.co_lin || resLin.recordset[0]?.id || null;
        let defaultSubl = data.co_subl || resSubl.recordset[0]?.id || null;
        let defaultCat = data.co_cat || resCat.recordset[0]?.id || null;
        let defaultColor = data.co_color || resCol.recordset[0]?.id || null;
